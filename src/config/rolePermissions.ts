...
export const rolePermissions: Record<string, RolePermissions> = {
  ...
  site_manager: {
    ...
    permissions: {
      canCreate: ['teams'],
      canEdit: ['sites', 'teams', 'workers'],
      canDelete: [],
      canExport: ['sites', 'workers', 'reports', 'offers'],
      canApprove: [],
    },
  },
  ...
  order_manager: {
    ...
    permissions: {
      canCreate: ['orders', 'order-processing'],
...
export const roleDescriptions: Record<string, string> = {
  ...
  site_manager: 'Manage construction sites, workers, and teams',
